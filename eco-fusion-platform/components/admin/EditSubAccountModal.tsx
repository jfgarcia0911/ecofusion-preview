 ...
 *
 * Only the name and where it is. Everything else about a business - its people,
 * its subscription, anything it owns - is changed from inside it, which means
 * opening a support session and being recorded doing it. A typo in a name is
 * not worth that, and pretending it is only teaches staff to keep a session
 * open all day.
 */
export default function EditSubAccountModal({
    ...
    business: { id: string; name: string; location: string | null } | null;
    onClose: () => void;
    onSaved: (business: { id: string; name: string; location: string | null }) => void;
}) {
            ...
            <div className="flex flex-col gap-5">
                ...
                <label className="flex flex-col gap-1.5">
                    ...
                    <span className="text-xs text-white/30">
                        Shown under the name in this list and in the account switcher. Leave it
                        empty to clear it.
                    </span>
                </label>
