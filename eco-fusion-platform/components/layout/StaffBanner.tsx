...
/**
 * Says, at all times, that this is somebody else's farm.
 *
 ...
 */
export default function StaffBanner({ farmName }: { farmName: string }) {
    ...
    return (
        <div className="flex items-center gap-3 px-4 py-3 rounded-xl border border-amber-400/40 bg-amber-400/15">
            ...
            <span className="text-sm text-amber-100 flex-1">
                ...
                <span className="font-semibold">{farmName}</span>, which is not your farm.
