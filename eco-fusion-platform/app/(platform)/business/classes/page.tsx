...
export default function BusinessClassesPage() {
    ...
    /**
     * Ask the server, which asks Stripe, whether a checkout was paid, and say
     * what came back. Used on return from Stripe's own page and when the
     * checkout inside this one reports that it finished.
     */
    ...
    useEffect(() => {
        ...
        (async () => {
            ...
            if (returned === "cancelled") {
                ...
                await confirmPurchase(returned);
            }
